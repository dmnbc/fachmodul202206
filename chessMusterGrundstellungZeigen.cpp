...
void userEingabe(std::string vonWo, std::string nachWo)
{
	std::cout << __LINE__ << "\n";
...
{
	std::cout << __LINE__ << "\n";
	std::string eingabeVon, eingabeNach;
	...
	userEingabe(eingabeVon, eingabeNach);
